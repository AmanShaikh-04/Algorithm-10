...
const ThreeBackground = () => {
  ...
  return <div ref={mountRef} className="absolute inset-0 z-0" style={{ opacity: 0.5 }} />;
};

// Animated Line Component
const AnimatedLine = ({ x1, y1, x2, y2, delay, duration, color, strokeWidth = 2.5 }) => {
...
const Group4SVG = ({ isDrawing }) => {
  const lineData = [
    { x1: "1.22721", y1: "169.92", x2: "87.1784", y2: "58.077", delay: 0.2, duration: 0.8 },
    { x1: "0.434512", y1: "170.405", x2: "97.1276", y2: "0.572083", delay: 0.35, duration: 1.0 },
    { x1: "86.4077", y1: "58.2285", x2: "109.408", y2: "95.2285", delay: 1.0, duration: 0.4 },
    { x1: "97.4182", y1: "0.246217", x2: "140.418", y2: "76.2462", delay: 1.15, duration: 0.5 },
    { x1: "108.728", y1: "95.0624", x2: "140.728", y2: "76.0624", delay: 1.5, duration: 0.35 },
  ];
  ...
  return (
    <svg width="141" height="171" viewBox="0 0 141 171" fill="none" className="w-full h-full">
      <defs>
      ...
      {isDrawing && lineData.map((line, idx) => (
        <AnimatedLine
          key={idx}
          x1={line.x1}
          y1={line.y1}
...
const Group1SVG = ({ isDrawing }) => {
  const lineData = [
    { x1: "0.863166", y1: "132.228", x2: "70.8602", y2: "131.583", delay: 0.6, duration: 0.5 },
    { x1: "70.1833", y1: "132.737", x2: "205.851", y2: "0.357864", delay: 0.8, duration: 1.1 },
    { x1: "0.270066", y1: "132.479", x2: "205.923", y2: "0.490149", delay: 1.2, duration: 0.9 },
  ];
  ...
  return (
    <svg width="206" height="133" viewBox="0 0 206 133" fill="none" className="w-full h-full">
      <defs>
        <linearGradient id="orangeGradientPro" x1="0%" y1="100%" x2="100%" y2="0%">
...
const Group6SVG = ({ isDrawing }) => {
  const lineData = [
    { x1: "0.441675", y1: "28.4332", x2: "26.4417", y2: "77.4332", delay: 1.7, duration: 0.4 },
    { x1: "26", y1: "77.1676", x2: "66", y2: "77.1675", delay: 1.85, duration: 0.3 },
    { x1: "65.5552", y1: "76.8958", x2: "26.5552", y2: "0.895835", delay: 2.0, duration: 0.5 },
    { x1: "0.627715", y1: "29.3338", x2: "26.6277", y2: "0.333772", delay: 2.25, duration: 0.3 },
  ];
  ...
  return (
    <svg width="66" height="78" viewBox="0 0 66 78" fill="none" className="w-full h-full">
      <defs>
  ...
  return (
    ...
    >
      <div className="relative flex items-center justify-center w-full h-full">
        <div className="relative scale-[0.6] sm:scale-75 md:scale-90 lg:scale-100" style={{ width: '350px', height: '400px' }}>
          <div className="absolute left-1/2 -translate-x-1/2" style={{ width: '350px', height: '400px' }}>
            ...
            >
              <h1 className="text-white text-center tracking-[0.3em] text-base sm:text-xl font-extralight uppercase whitespace-nowrap">
                Algorithm X
              </h1>
            </motion.div>
          </div>
